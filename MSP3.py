            ...
            try:
                with open(file_path, 'r', encoding='utf-8') as f:
                    ...
                    if lang_code in data:
                        # Get the display name from the language file itself
...
class SensorGUI:
    def __init__(self, root):
        ...
        #pyinstaller already sets the icon
    ...
    def create_language_selection(self):
        ...
        try:
            current_index = language_values.index(CURRENT_LANGUAGE)
    ...
    def on_language_change(self, event=None):
        ...
        if 0 <= selected_index < len(self.language_values):
            CURRENT_LANGUAGE = self.language_values[selected_index]
            # Update GUI text
